...
class Packet {
 ...
 public:
    ...
    Packet() {_is_header = false; _bounced = false; _type = IP; _flags = 0; _from_large_flow = 0;}; 
    ...
    bool from_large_flow() {return _from_large_flow;}
    void set_from_large_flow(bool is_large) {_from_large_flow = is_large;}

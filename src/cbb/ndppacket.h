...
class NdpPacket : public Packet {
 public:
    ...
    //
    inline static NdpPacket* newpkt(networkDevices* net, dynamicTopology* top, PacketFlow &flow, int src, int dst, NdpSrc* ndpsrc,
...
class NdpAck : public Packet {
 public:
    ...
    inline static NdpAck* newpkt(networkDevices* net, dynamicTopology* top, PacketFlow &flow, int src, int dst,
...
class NdpNack : public Packet {
 public:
    ...
    inline static NdpNack* newpkt(networkDevices* net, dynamicTopology* top, PacketFlow &flow, int src, int dst,
        NdpSrc* ndpsrc, seq_t pacerno, seq_t ackno, seq_t cumulative_ack, seq_t pullno) {
